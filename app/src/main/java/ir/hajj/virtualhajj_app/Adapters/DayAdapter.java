...
public class DayAdapter extends RecyclerView.Adapter<DayAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int i) {
        ...
        if(MyApp.GetEnglishNumber(currentDate).compareTo(items.get(i).getTime())>=0) {
            ...
            holder.b.setColorFilter(Color.parseColor("#000000"), android.graphics.PorterDuff.Mode.SRC_IN);
        }else {
            ...
            public void onClick(View v) {
                if(MyApp.GetEnglishNumber(currentDate).compareTo(items.get(i).getTime())>=0) {
                    if (items.get(i).getType().equals("text")) {
                        ...
                        TextView title=dialog.findViewById(R.id.title);
                        title.setText(items.get(i).getTitle());
                        final LinearLayout loading=dialog.findViewById(R.id.loading);
                        ...
                        btnPlay.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (mp != null) {
                                    ...
                                    play(items.get(i).getContent(),loading);
                                }
                            }
                        });
    ...
    public  void play(final String pos, final LinearLayout loading){
